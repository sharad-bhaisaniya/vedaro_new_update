...
color: white;
   ...
   <body>
    ...
    <div id="topbar" class="text-white small py-2 px-3 d-flex align-items-center justify-content-between fixed-top w-100"
        ...
        <div>
            Private Sale at |
            <a href="#" class="text-white text-decoration-underline">RSVP</a>
        </div>
        <div class="small">US / USD</div>
    </div>
                ...
                <div class="d-none d-lg-flex w-100 justify-content-between align-items-center navbar-desktop">
                   ...
                   <h6 class="header__heading mobile-header-logo d-flex align-itms-center m-0"> <a href="/" class="header__heading-link navbar-brand" style="text-decoration:none;">
                    ...
                    <div class="header-icons d-flex align-items-center gap-3">
                        ...
                        <a href="/global-search" class="header-icon" title="Search">
                            <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 15 15" fill="currentColor">
  ...
  {{-- <footer class="bg-dark text-white pt-5">
    <div class="container">
        ...
        <h1 class="display-5 fw-light" style="letter-spacing: 5px; font-family: serif;">VEDARO</h1>
        </div>

        <div class="row gy-5 align-items-start">
        <!-- Brand Image -->
        <div class="col-12 col-md-3 text-center text-md-start">
            <img src="{{ asset('/assets/images/vedaro_logo.png') }}" alt="VEDARO Logo"
        ...
        <div class="col-6 col-md-3">
            ...
            <li><a href="#" class="footer-link"><i class="fas fa-phone me-2"></i>Contact</a></li>
            <li><a href="#" class="footer-link"><i class="fas fa-question-circle me-2"></i>FAQs</a></li>
            <li><a href="#" class="footer-link"><i class="fas fa-user me-2"></i>About</a></li>
            <li><a href="#" class="footer-link"><i class="fas fa-store me-2"></i>Boutique Locator</a></li>
            <li><a href="#" class="footer-link"><i class="fas fa-book-open me-2"></i>Journal</a></li>
            </ul>
        </div>
        ...
        <div class="col-6 col-md-3">
            ...
            <ul class="list-unstyled small">
            <li><a href="#" class="footer-link"><i class="fab fa-instagram me-2"></i>Instagram</a></li>
            <li><a href="#" class="footer-link"><i class="fab fa-tiktok me-2"></i>TikTok</a></li>
            <li><a href="#" class="footer-link"><i class="fab fa-threads me-2"></i>Threads</a></li>
            </ul>
        </div>
        ...
        <div class="col-12 col-md-3">
            ...
            <form>
            <div class="mb-2">
                <input type="email" class="form-control bg-transparent border-white text-white rounded-0"
                placeholder="Enter your email">
            </div>
            <button type="submit"
                class="btn btn-light w-100 text-dark fw-semibold text-uppercase btn-sm">Subscribe</button>
            </form>
        </div>
        </div>

        <!-- Disclaimer -->
        <div class="mt-5 bg-secondary py-2 text-white small">
        <marquee behavior="scroll" direction="left" scrollamount="4">
            The brand presented in this demo store is fictional. Any resemblance to actual brands, products, or persons is coincidental. 🤍
        </marquee>
        </div>

        <!-- Footer Bottom -->
        <div class="text-center py-3 text-white-50 small border-top border-light mt-4">
        © 2025 VEDARO Precision &nbsp; | &nbsp; Powered by Shopify
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row gy-5 align-items-start">
            ...
            <div class="col-6 col-md-3">
                ...
                <ul class="list-unstyled small">
                    <li><a href="#" class="footer-link text-white-50 text-decoration-none">CONTACT</a></li>
                    <li><a href="#" class="footer-link text-white-50 text-decoration-none">FAQS</a></li>
                    <li><a href="/about" class="footer-link text-white-50 text-decoration-none">ABOUT</a></li>
                    <li><a href="#" class="footer-link text-white-50 text-decoration-none">FIND A BOUTIQUE</a></li>
                    <li><a href="#" class="footer-link text-white-50 text-decoration-none">JOURNAL</a></li>
                </ul>
            </div>

            <div class="col-6 col-md-3">
                <h5 class="fw-semibold mb-3 footer-heading">Connect</h5>
                <ul class="list-unstyled small">
                    <li><a href="#" class="footer-link text-white-50 text-decoration-none">INSTAGRAM</a></li>
                    <li><a href="#" class="footer-link text-white-50 text-decoration-none">TIKTOK</a></li>
                    <li><a href="#" class="footer-link text-white-50 text-decoration-none">THREADS</a></li>
                </ul>
            </div>
            ...
            <div class="col-12 col-md-3">
                ...
                <p class="text-white-50 small newsletter-text">
                    Sign up for Primavera's newsletter & be the first to discover the latest collections, special offers, and behind-the-scenes glimpses.
                </p>
                <form>
                    <div class="mb-3">
        ...
        <div class="mt-5 py-2 text-white-50 small footer-disclaimer">
            <marquee behavior="scroll" direction="left" scrollamount="4">
                The brand presented in this demo store is fictional. Any resemblance to actual brands, products, or persons is coincidental. 🤍
            </marquee>
        </div>
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-center py-3 text-white-50 small border-top border-light mt-4 footer-bottom-section">
            <div class="footer-bottom-left mb-2 mb-md-0">
                <a href="/privacy_policy" class="footer-link-bottom text-white-50 text-decoration-none">PRIVACY POLICY</a>
            </div>
            <div class="footer-bottom-right text-center text-md-end">
                <span>© 2025 PRIMAVERA PRECISION &nbsp; | &nbsp; POWERED BY SHOPIFY</span>
            </div>
        </div>
    </div>
</footer>
...
<!--<footer class="bg-dark text-white py-2 w-100 fixed-bottom d-lg-none shadow-lg">-->
...
<!--                <small class="mt-1">Wishlist</small>-->
<!--            </a>-->
<!--            <a href="#" class="bottom-nav-item text-white-50 text-decoration-none d-flex flex-column align-items-center flex-grow-1">-->
...
<div id="myFixedBottomElement" class="bg-dark text-white text-center py-2 shadow-lg">
    <div class="container-fluid">
        <div class="d-flex justify-content-around align-items-center">
            ...
            <a href="/global-search" class="bottom-nav-item text-white-50 text-decoration-none d-flex flex-column align-items-center flex-grow-1">
                <i class="fas fa-search fs-5"></i>
                <small class="mt-1">Search</small>
            </a>
      ...
      <!--</script>-->
        ...
        <!--using for cart update counter of the carts item -->
        <script>
            function updateCartCount() {
                $.ajax({
                    url: "{{ route('cart.count') }}",
